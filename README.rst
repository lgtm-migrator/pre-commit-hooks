...
.. |commits-since| image:: https://img.shields.io/github/commits-since/domdfcoding/pre-commit-hooks/v0.1.5
...
.. code-block:: yaml
	...
	-   repo: https://github.com/domdfcoding/pre-commit-hooks
	    rev: v0.1.5  # Use the ref you want to point at
	    hooks:
...
Sorts `PEP 508 <https://www.python.org/dev/peps/pep-0508/>`_ entries in requirements.txt and removes invalid entries, including ``pkg-resources==0.1.5``.
